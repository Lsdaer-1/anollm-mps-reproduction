...
def main():
	...
	model_path = args.save_dir / f"{run_name}.pt"
	dataset_tmp_path = args.save_dir / f"{run_name}_data"
	...
	if args.wandb:
		wandb.init(
			...
			name=f"{args.dataset}_splits{args.split_idx}_{args.n_splits}_{run_name}",
		)
